<template>  
    ...
    <div v-show="isNavbarVisible" class="sidebar">
      ...
      <div class="menu-group">
        ...
        <div class="menu-item">
          <img src="@/assets/marketing.png" alt="Marketing Team" class="menu-icon" />
        ...
        <div class="menu-item">
          <img src="@/assets/development.png" alt="Development Team" class="menu-icon" />
      ...
      <div class="bottom-section">
        <div class="menu-item">
          <img src="@/assets/add-user.png" alt="Invite Teammates" class="menu-icon" />
